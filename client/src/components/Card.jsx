...
//Tilt gives movement effect
import Tilt from 'react-parallax-tilt';

import styles from '../styles';
import { allCards } from '../assets';

//this func helps us generate a random card for each playr
...
//a reference made to card
//att is attack strength of playr
const Card = ({ card, title, restStyles, cardRef, playerTwo }) => (
  //wrap this div with Tilt & then see the effect
  <Tilt>
